...
export default function Navbar({ onMenuClick }) {
  ...
  return (
    <header className="sticky top-0 z-20 bg-white dark:bg-dark-card border-b border-light-border dark:border-dark-border px-4 h-14 flex items-center justify-between gap-4 safe-top">
      {/* Left */}
