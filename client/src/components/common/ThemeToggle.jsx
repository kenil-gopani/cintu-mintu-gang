...
export default function ThemeToggle({ size = 'md' }) {
  ...
  // Scale the toggle to fit nicely in the navbar (approx 48px wide)
  const toggleSize = size === 'md' ? '4.5px' : '6px'

  return (
    <div className="cmg-bb8-wrapper" style={{ '--toggle-size': toggleSize }}>
      <style>{`
        .cmg-bb8-wrapper .bb8-toggle {
        ...
        .cmg-bb8-wrapper *,
        .cmg-bb8-wrapper *::before,
        .cmg-bb8-wrapper *::after {
        ...
        .cmg-bb8-wrapper .bb8-toggle__checkbox {
          appearance: none;
          display: none;
        }

        .cmg-bb8-wrapper .bb8-toggle__container {
        ...
        .cmg-bb8-wrapper .bb8__head-container {
          position: relative;
          transition: var(--transition);
          z-index: 2;
        ...
        .cmg-bb8-wrapper .bb8__head::before {
          content: "";
          position: absolute;
          width: 0.563em;
          height: 0.563em;
        ...
        .cmg-bb8-wrapper .bb8__head::after {
          content: "";
          position: absolute;
          bottom: 0.375em;
          left: 0;
        ...
        .cmg-bb8-wrapper .bb8__antenna:nth-child(1) {
          height: 0.938em;
          right: 0.938em;
          background: linear-gradient(#000 0.188em, silver 0.188em);
        }

        .cmg-bb8-wrapper .bb8__antenna:nth-child(2) {
          height: 0.375em;
          left: 50%;
        ...
        .cmg-bb8-wrapper .bb8__body::after {
          content: "";
          bottom: 1.5em;
          left: 0.563em;
          position: absolute;
        ...
        .cmg-bb8-wrapper .bb8__body::before {
          content: "";
          width: 2.625em;
          height: 2.625em;
          position: absolute;
        ...
        .cmg-bb8-wrapper .artificial__hidden {
          position: absolute;
        ...
        .cmg-bb8-wrapper .bb8-toggle__scenery {
          width: 100%;
          height: 100%;
          pointer-events: none;
          overflow: hidden;
        ...
        .cmg-bb8-wrapper .bb8-toggle__scenery::before {
          content: "";
          position: absolute;
          width: 100%;
          height: 30%;
        ...
        .cmg-bb8-wrapper .bb8-toggle__cloud {
          z-index: 1;
          position: absolute;
          border-radius: 50%;
        }

        .cmg-bb8-wrapper .bb8-toggle__cloud:nth-last-child(1) {
          width: 0.875em;
          height: 0.625em;
        ...
        .cmg-bb8-wrapper .bb8-toggle__cloud:nth-last-child(2) {
          top: 0.625em;
          right: 4.375em;
          width: 0.875em;
          height: 0.375em;
        ...
        .cmg-bb8-wrapper .bb8-toggle__cloud:nth-last-child(3) {
          top: 1.25em;
          right: 0.938em;
          width: 0.875em;
          height: 0.375em;
        ...
        .cmg-bb8-wrapper .gomrassen,
        .cmg-bb8-wrapper .hermes,
        .cmg-bb8-wrapper .chenini {
          position: absolute;
          border-radius: var(--radius);
        ...
        .cmg-bb8-wrapper .gomrassen::before,
        .cmg-bb8-wrapper .gomrassen::after {
          content: "";
          position: absolute;
          border-radius: inherit;
        ...
        .cmg-bb8-wrapper .tatto-1,
        .cmg-bb8-wrapper .tatto-2 {
          position: absolute;
          width: 1.25em;
          height: 1.25em;
          border-radius: var(--radius);
        ...
        .cmg-bb8-wrapper .bb8-toggle__star {
          position: absolute;
          width: 0.063em;
          height: 0.063em;
          background: #fff;
        ...
        .cmg-bb8-wrapper .bb8-toggle__star:nth-child(1) {
          left: 3.75em;
        ...
        .cmg-bb8-wrapper .bb8-toggle__star:nth-child(2) {
          left: 4.688em;
        ...
        .cmg-bb8-wrapper .bb8-toggle__star:nth-child(3) {
          left: 5.313em;
        ...
        .cmg-bb8-wrapper .bb8-toggle__star:nth-child(4) {
          left: 1.875em;
          width: 0.125em;
          height: 0.125em;
          transition: 0.5s;
        ...
        .cmg-bb8-wrapper .bb8-toggle__star:nth-child(5) {
          left: 5em;
          width: 0.125em;
          height: 0.125em;
          transition: 0.6s;
        ...
        .cmg-bb8-wrapper .bb8-toggle__star:nth-child(6) {
          left: 2.5em;
          width: 0.125em;
          height: 0.125em;
          transition: 0.7s;
        ...
        .cmg-bb8-wrapper .bb8-toggle__star:nth-child(7) {
          left: 3.438em;
          width: 0.125em;
          height: 0.125em;
          transition: 0.8s;
        ...
        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked
        ...
        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked + .bb8-toggle__container .bb8-toggle__cloud {
          right: -100%;
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked + .bb8-toggle__container .gomrassen {
          top: 0.938em;
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked + .bb8-toggle__container .hermes {
          top: 2.5em;
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked + .bb8-toggle__container .chenini {
          top: 2.75em;
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked + .bb8-toggle__container {
          background-position-y: 0;
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked + .bb8-toggle__container .tatto-1 {
          top: 100%;
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked + .bb8-toggle__container .tatto-2 {
          top: 100%;
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked + .bb8-toggle__container .bb8 {
          left: calc(100% - var(--bb8-diameter) - var(--toggle-offset));
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked + .bb8-toggle__container .bb8__shadow {
          left: calc(100% - var(--bb8-diameter) - var(--toggle-offset) + 0.938em);
          transform: skew(70deg);
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked + .bb8-toggle__container .bb8__body {
          transform: rotate(225deg);
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:hover + .bb8-toggle__container .bb8__head::before {
          left: 100%;
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:not(:checked):hover
          + .bb8-toggle__container
          .bb8__antenna:nth-child(1) {
          right: 1.5em;
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:hover
          + .bb8-toggle__container
          .bb8__antenna:nth-child(2) {
          left: 0.938em;
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:hover + .bb8-toggle__container .bb8__head::after {
          background-position: 1.375em 0;
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked:hover
          + .bb8-toggle__container
          .bb8__head::before {
          left: 0;
        }
        ...
        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked:hover + .bb8-toggle__container .bb8__head::after {
          background-position: -1.375em 0;
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:active + .bb8-toggle__container .bb8__head-container {
          transform: rotate(25deg);
        }

        .cmg-bb8-wrapper .bb8-toggle__checkbox:checked:active
          + .bb8-toggle__container
          .bb8__head-container {
          transform: rotate(-25deg);
        }

        .cmg-bb8-wrapper .bb8:hover .bb8__head::before,
        .cmg-bb8-wrapper .bb8:hover .bb8__antenna:nth-child(2) {
          left: 50% !important;
        }

        .cmg-bb8-wrapper .bb8:hover .bb8__antenna:nth-child(1) {
          right: 0.938em !important;
        }

        .cmg-bb8-wrapper .bb8:hover .bb8__head::after {
